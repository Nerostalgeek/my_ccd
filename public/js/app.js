...
},{"core-js/fn/regexp/escape":2,"core-js/shim":295,"regenerator-runtime/runtime":298}],2:[function(require,module,exports){
...
},{"qC859L":297}],299:[function(require,module,exports){
'use strict';
...
},{"./dom":304}],301:[function(require,module,exports){
'use strict';
...
},{"./dom":304}],302:[function(require,module,exports){
'use strict';
...
var CemeteryController = function (_Controller) {
    _inherits(CemeteryController, _Controller);

    function CemeteryController(selector, parent) {
        _classCallCheck(this, CemeteryController);

        var _this = _possibleConstructorReturn(this, (CemeteryController.__proto__ || Object.getPrototypeOf(CemeteryController)).call(this, selector, parent));
    ...
    _createClass(CemeteryController, [{
        key: 'onDiscardCard',
        value: function onDiscardCard(card) {
...
exports.default = Dom;
},{"../eventManager":307,"jquery-browserify":296}],305:[function(require,module,exports){
'use strict';
...
},{"./dom":304}],306:[function(require,module,exports){
'use strict';
...
},{"./board":300,"./cemetary":302,"./deck":303,"./dom":304,"./hand":305}],307:[function(require,module,exports){
"use strict";
...
exports.default = {
    ...
    setEnv: function setEnv() {
        var paramEnv = arguments.length <= 0 || arguments[0] === undefined ? 'prod' : arguments[0];
